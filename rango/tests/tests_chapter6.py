...
class Chapter6IndexViewTests(TestCase):
    ...
    def test_index_context_dictionary(self):
        ...
        expected_pages_order = list(
            Page.objects.order_by("-views")[:5]
        ...
        self.assertTrue(
            "boldmessage" in self.response.context,
        ...
        self.assertEquals(
            expected_boldmessage,
            self.response.context["boldmessage"],
        ...
        self.assertTrue(
            "categories" in self.response.context,
        ...
        self.assertEqual(
            type(self.response.context["categories"]),
            QuerySet,
        ...
        self.assertTrue(
            "pages" in self.response.context,
        ...
        self.assertEqual(
            type(self.response.context["pages"]),
            QuerySet,
        ...
        self.assertEqual(
            expected_pages_order,
            list(self.response.context["pages"]),
    ...
    def test_index_categories(self):
        ...
        category_li_entries_regex = [  # 0 = regex match, 1 = title of category, 2 = sanitised markup for error message
            [
                ...
                "Python",
                '<li><a href="/rango/category/python/">Python</a></li>',
            ],
            [
                r'<li>(\s*|\n*)<a(\s+)href(\s*)=(\s*)("/rango/category/django/"|\'/rango/category/django/\')(\s*)>(\s*|\n*)Django(\s*|\n*)</a>(\s*|\n*)</li>',
                "Django",
                '<li><a href="/rango/category/django/">Django</a></li>',
            ],
            [
                r'<li>(\s*|\n*)<a(\s+)href(\s*)=(\s*)("/rango/category/other-frameworks/"|\'/rango/category/other-frameworks/\')(\s*)>(\s*|\n*)Other Frameworks(\s*|\n*)</a>(\s*|\n*)</li>',
                "Other Frameworks",
                '<li><a href="/rango/category/other-frameworks/">Other Frameworks</a></li>',
            ],
        ]
        ...
        for entry in category_li_entries_regex:
            self.assertTrue(
                re.search(entry[0], self.content),
    ...
    def test_index_pages(self):
        ...
        for expected_regex in expected_pages_li:
            print(self.content)
            self.assertTrue(
                re.search(expected_regex, self.content),
...
class Chapter6NoItemsIndexViewTests(TestCase):
    ...
    def test_empty_index_context_dictionary(self):
        ...
        self.assertEqual(
            len(self.response.context["categories"]),
            0,
        ...
        self.assertEqual(
            len(self.response.context["pages"]),
            0,
    ...
    def test_sample_category(self):
        ...
        self.assertTrue(
            re.search(category_regex, updated_response),
...
class Chapter6CategoryViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.response = self.client.get(
            reverse(
                "rango:show_category", kwargs={"category_name_slug": "other-frameworks"}
            )
        )
        self.content = self.response.content.decode()
    ...
    def test_context_dictionary(self):
        ...
        self.assertTrue(
            "category" in self.response.context,
    ...
    def test_response_markup(self):
        ...
        self.assertTrue(
            re.search(bottle_markup, self.content),
        ...
        self.assertTrue(
            re.search(flask_markup, self.content),
            f"{FAILURE_HEADER}Correctly formed <li> markup was not found for the pages to be displayed in the show_category() view. Make sure your category.html template is well-formed!{FAILURE_FOOTER}",
        )
    ...
    def test_for_homepage_link(self):
        ...
        self.assertTrue(
            re.search(homepage_hyperlink_markup, self.content),
...
class Chapter6BadCategoryViewTests(TestCase):
    ...
    def test_nonexistent_category(self):
        ...
        response = self.client.get(
            reverse(
                "rango:show_category",
                kwargs={"category_name_slug": "nonexistent-category"},
            )
        )
    ...
    def test_empty_category(self):
        ...
        response = self.client.get(
            reverse(
                "rango:show_category", kwargs={"category_name_slug": "test-category"}
            )
        )
